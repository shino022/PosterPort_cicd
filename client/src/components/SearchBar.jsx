  ...
  return (
    ...
    >
      <select
        ...
        className="px-4 py-2 bg-white border-r border-gray-300 focus:outline-none rounded-l-lg"
      >
      ...
      <button
        type="submit"
        className="px-4 py-2 bg-blue-500 text-white focus:outline-none flex items-center justify-center rounded-r-md"
      >
